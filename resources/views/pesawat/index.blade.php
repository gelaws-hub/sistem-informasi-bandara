...
<a href="{{ route('pesawat.restore') }}" type="button" class="btn btn-success rounded-3">Restore Data</a>
<p> </p><br>
    ...
    <tbody>
        @foreach ($datas as $data)
            <tr>
                ...
                <td>
                    <a href="{{ route('pesawat.edit', $data->id_pesawat) }}" type="button" class="btn btn-warning rounded-3">Ubah</a>

                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusModal{{ $data->id_pesawat }}">
                        Hapus
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="hapusModal{{ $data->id_pesawat }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#softhapusModal{{ $data->id_pesawat }}">
                    Hapus Sementara
                </button>

                <div class="modal fade" id="softhapusModal{{ $data->id_pesawat }}" tabindex="-1" aria-labelledby="softhapusModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
