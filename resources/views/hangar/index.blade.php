...
@section('content')
    ...
    <a href="{{ route('hangar.restorepage') }}" type="button" class="btn btn-success rounded-3">Restore Data</a>
    <p> </p><br>
        ...
        <tbody>
            @foreach ($datas as $data)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('hangar.edit', $data->id_hangar) }}" type="button"
                        ...
                        <div class="modal fade" id="softhapusModal{{ $data->id_hangar }}" tabindex="-1"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('hangar.softDelete', $data->id_hangar) }}">
                                        @csrf
                                        <div class="modal-body">
                                            Apakah anda yakin ingin menghapus {{ $data->nama_hangar }} ini?
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Tutup</button>
